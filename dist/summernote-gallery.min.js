  ...
  _createClass(GalleryModal, [{
    ...
    value: function createImages(data, page) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        var $item = $('<div class="col-md-2 img-item">' + '<i class="fa fa-check"></i>' + '<span class="loading">' + '<i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>' + '</span>' + '</div>');
        $item.prepend($image);
        $content.append($item);
      }
...
/* harmony import */ var _EventManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EventManager */ "./src/Module/EventManager.js");
/* harmony import */ var _GalleryModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GalleryModal */ "./src/Module/GalleryModal.js");
/* harmony import */ var _DataManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DataManager */ "./src/Module/DataManager.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var SummernoteGallery = /*#__PURE__*/function () {
  ...
  _createClass(SummernoteGallery, [{
    ...
    value: function initGallery(context) {
      ...
      this.modal = new _GalleryModal__WEBPACK_IMPORTED_MODULE_1__["default"](this.plugin_options.modal);
      this.data_manager = new _DataManager__WEBPACK_IMPORTED_MODULE_2__["default"](this.plugin_options.source);
  ...
  _createClass(GalleryPlugin, [{
    ...
    value: function getPlugin() {
      ...
      plugin[this.options.name] = function (context) {
        var summernote_gallery = new _SummernoteGallery__WEBPACK_IMPORTED_MODULE_0__["default"](_this.options); // add gallery button
