  ...
  _createClass(GalleryPlugin, [{
    ...
    value: function getPlugin() {
      ...
      plugin[options.name] = function (context) {
        ...
        var buttonLabel = ((_context$options$opti = context.options[options.name]) === null || _context$options$opti === void 0 ? void 0 : _context$options$opti.buttonLabel) || _this.summernote_gallery.options.buttonLabel;
